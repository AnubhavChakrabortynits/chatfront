...
const navigate=useNavigate()
  ...
  return (
    ...
    <h4 className='innerdesc'>Just Chat Is An Online Chatting Platform Where Users Can Create And Join Rooms And Have A Chat.
     ...
     <br/><br/><div style={{color:"#ffca90"}}> Also Just Chat Has The Feature Of Chat Backup ..So On Page Refresh Or Reload The Chats Wont Get Deleted...</div>
    </h4> 
     <br/>

     <h2 style={{color:'#ff7793'}}>How To Use Just Chat ?</h2>
     <ul>
      <li>Hit The Get Started Button. It Will Lead You To The Signup Page</li>
      <li>SignUp With a username and a password. If You Are Already a User Then click goto Login Button To Go The Login Page.</li>
     ...
     <h2 style={{color:'#ff7793'}}>Admin Features !</h2>
     <ul>
